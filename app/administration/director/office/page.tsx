...
import { ChevronRight, Loader2, Phone, Mail } from 'lucide-react';
...
export default function DirectorOfficePage() {
  ...
  useEffect(() => {
    fetch(`${API_BASE}/api/administration/director-office`, { cache: 'no-store' })
      .then((res) => res.json())
      .then((data) => {
      ...
      <div className="bg-gray-50 border-b border-gray-200 py-3 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-xs text-gray-600 font-medium">
          ...
          <span className="text-[#631012] font-bold">
            {isHindi ? 'निदेशक कार्यालय' : "Director's Office"}
          </span>
        </div>
      </div>
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
        <div className="text-center space-y-2">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 tracking-tight">
            {isHindi ? 'निदेशक कार्यालय कर्मचारी' : "Director's Office Staff"}
          </h1>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg border border-gray-300 shadow-sm overflow-hidden">
            <div className="bg-[#e9f2f8] border-b border-gray-300 px-6 py-3 text-center">
              <h2 className="text-base font-bold text-[#0c344e]">Office Staff Details</h2>
            </div>
