...
export default function InstituteCoordinatorPage() {
  ...
  const [list, setList] = useState<CoordinatorRecord[]>([]);
      ...
      <div className="bg-gray-50 border-b border-gray-200 py-3 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto flex items-center gap-2 text-xs text-gray-600 font-medium">
          ...
          <span className="text-[#631012] font-bold">
            {isHindi ? 'संस्थान समन्वयक' : 'Institute Coordinators'}
          </span>
        </div>
      </div>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 bg-white border border-gray-200 rounded">
            ...
            <p className="text-xs font-mono text-gray-500">Loading coordinators...</p>
          </div>
        ) : (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs sm:text-sm text-gray-800 border-collapse">
                ...
                <tbody className="divide-y divide-gray-200 bg-white">
                  {list.map((c, i) => (
                    <tr key={c.id || i} className="hover:bg-gray-50/80 transition-colors">
                      ...
                      <td className="py-3.5 px-6 border-r border-gray-200 font-medium text-gray-800 align-top">
                        {c.responsibility}
                      </td>
