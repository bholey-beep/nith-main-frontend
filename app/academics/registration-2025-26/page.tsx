...
type Doc = { id: string; title: string; date?: string; url?: string };

const DOCS: Doc[] = [
  {
    id: 'r1',
    title:
      'List of Allocated Open Elective Courses for 5th Semester Registration – Academic Year 2025–26',
    date: '2025-06-20',
    url: '/pdfs/allocated-open-electives-5th-2025-26.pdf',
  },
  {
    id: 'r2',
    title:
      'Notice: Procedure and Academic Fee Details for Odd Semester Registration - July 2025',
    date: '2025-07-01',
    url: '/pdfs/procedure-fee-odd-registration-jul-2025.pdf',
  },
  {
    id: 'r3',
    title:
      'Notice: Physical Reporting and Document Verification Schedule for B.Tech./B.Arch./Dual Degree 1st Year Students through JoSAA/CSAB 2025',
    date: '2025-07-15',
    url: '/pdfs/physical-reporting-joSAA-csab-2025.pdf',
  },
];
      ...
      <section className="relative bg-gradient-to-br from-[#800000] via-[#631012] to-[#8B1E1E] overflow-hidden">
        ...
        >
          ...
          <p className="text-white/90 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed font-light">
            Important registration notices and schedules for Academic Year
            2025-26 — view or download documents below.
          </p>
        </motion.div>
      </section>
      ...
      <main className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <section className="bg-white rounded-lg shadow-sm p-6">
          ...
          <p className="mt-2 text-gray-700 text-sm">
            Check the documents for detailed registration procedures, deadlines,
            and verification schedules. For queries, contact the Office of
            Academic Affairs at{' '}
            <a
