...
const ORDINANCES = [
  {
    id: 'd2024',
    title: 'Doctoral Ordinances w.e.f. 2024',
    year: '2024',
    url: '/pdfs/doctoral-ordinances-2024.pdf',
  },
  {
    id: 'd2020',
    title: 'Doctoral Ordinances w.e.f. 2020',
    year: '2020',
    url: '/pdfs/doctoral-ordinances-2020.pdf',
  },
  {
    id: 'd2016',
    title: 'Doctoral Ordinances w.e.f. 2016',
    year: '2016',
    url: '/pdfs/doctoral-ordinances-2016.pdf',
  },
];
      ...
      <section className="relative bg-gradient-to-br from-[#800000] via-[#631012] to-[#8B1E1E] overflow-hidden">
        ...
        >
          ...
          <p className="text-white/90 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed font-light">
            Ordinances governing doctoral programmes — view or download official
            PDFs below.
          </p>
        </motion.div>
      </section>
      ...
      <main className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        <section className="bg-white rounded-lg shadow-sm p-6">
          ...
          <p className="mt-2 text-gray-700 text-sm">
            The ordinances above are authoritative. For clarifications, contact
