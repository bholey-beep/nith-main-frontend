...
const ORDINANCES = [
  {
    id: 'o2024',
    title: "Bachelor's Ordinances w.e.f. 2024",
    year: '2024',
    url: '/pdfs/bachelors-ordinances-2024.pdf',
  },
  {
    id: 'o2023',
    title: "Bachelor's Ordinances w.e.f. 2023",
    year: '2023',
    url: '/pdfs/bachelors-ordinances-2023.pdf',
  },
  {
    id: 'o2019',
    title: "Bachelor's Ordinances w.e.f. 2019",
    year: '2019',
    url: '/pdfs/bachelors-ordinances-2019.pdf',
  },
];
      ...
      <section className="relative bg-gradient-to-br from-[#800000] via-[#631012] to-[#8B1E1E] overflow-hidden">
        ...
        >
          ...
          <p className="text-white/90 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed font-light">
            Ordinances governing the Bachelor&apos;s programmes — view or
            download the official PDFs below.
          </p>
        </motion.div>
      </section>
